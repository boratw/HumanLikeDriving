...
with sess.as_default():
    ...
    for pkl_index in range(1, 18):
        ...
        for step in range(step_start_index):
        ...
        for x in range(agent_count):
            with open("readed_231122/exp_" + str(pkl_index) + "/readed_" + str(x) + ".tsv", "wt") as f:
                f.write("""pos_x\tpos_y\t\
...
""")
                for current_step in range(step_start_index, step_start_index + step_count):
                    ...
                    rx1 = state_vectors[current_step + 20][x][0] - px
                    ry1 = state_vectors[current_step + 20][x][1] - py
                    px1, py1 = rotate(rx1, ry1, yawsin, yawcos)

                    rx2 = state_vectors[current_step + 40][x][0] - px
                    ry2 = state_vectors[current_step + 40][x][1] - py
                    px2, py2 = rotate(rx2, ry2, yawsin, yawcos)

                    rx3 = state_vectors[current_step + 60][x][0] - px
                    ry3 = state_vectors[current_step + 60][x][1] - py
