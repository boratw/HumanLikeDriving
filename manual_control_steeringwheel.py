...
class World(object):
    ...
    def restart(self):
        ...
        while self.player is None:
            ...
            self.player = self.world.try_spawn_actor(blueprint, spawn_point)
        # Set up the sensors.
        self.collision_sensor = None #CollisionSensor(self.player, self.hud)
        self.lane_invasion_sensor = None #LaneInvasionSensor(self.player, self.hud)
        self.gnss_sensor = None #GnssSensor(self.player)
