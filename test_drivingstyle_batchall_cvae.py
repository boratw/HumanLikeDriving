...
log_txt = open("test_log/log4_2/module" + str(module_n) + ".txt", "wt")
...
with sess.as_default():
    ...
    for pkl_name in pkl_names:
        with open("test_log/log4_2/module" + str(module_n) + "_" + pkl_name + ".txt", "wt") as log_exp_txt :
            ...
            for exp_index in range(len(data)):
                ...
                if module_n == 2:
                    for step in range(step_count // 4):
                        ...
                        global_latent += res_mu
                    
                    global_latent_step += (step_count // 4)
                    global_latent_mean = global_latent / global_latent_step
                ...
                for step in range(step_count // 4):
                    ...
                    for x in range(agent_count):
                        ...
                        if -5. < d_route[max_action][4] < 5. and -5. < d_route[max_action][5] < 5. :
                            prob_res[x] += prob
                            prob_var[x] += prob ** 2
