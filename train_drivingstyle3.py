...
log_file = open("train_log/DrivingStyle3/log_" + log_name + ".txt", "wt")
...
with sess.as_default():
    with multiprocessing.Pool(processes=50) as pool:
        learner = DrivingStyleLearner(state_len=state_len, nextstate_len=nextstate_len, agent_for_each_train=agent_for_each_train, global_latent_len=global_latent_len, global_regularizer_weight=0.001)
        ...
        for epoch in range(1, 10000):
            ...
            if epoch % 50 == 0:
                learner_saver.save(sess, "train_log/DrivingStyle3/log_" + log_name + "_" + str(epoch) + ".ckpt")
