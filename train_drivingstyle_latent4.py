...
from network.DrivingStyle7_bayesian_latent import DrivingStyleLearner
...
log_name = "train_log/DrivingStyle7_Bayesian_Latent/log_" + datetime.now().strftime("%Y-%m-%d-%H-%M-%S")
